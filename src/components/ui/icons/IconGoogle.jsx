/**
 * Logo do Google — botão "Continuar com Google" do login (node 30:4276).
 *
 * Mesma situação do IconApple: o node é um PNG achatado do botão inteiro, não
 * um componente. Este é o "G" oficial em vetor.
 *
 * Ao contrário dos outros ícones da pasta, as cores são fixas — são as quatro
 * da marca e não podem herdar `currentColor`.
 */
